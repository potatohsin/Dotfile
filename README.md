...
```
// Install Fedora 38(Mininal) by Fedora Server
[click here](https://fedoraproject.org/server/download) to download and install Fedora 38.
```
...
Reboot and Enroll MOK.Other options got to [RPM Fusion/Howto/Secure Boot](https://rpmfusion.org/Howto/Secure%20Boot?highlight=%28%5CbCategoryHowto%5Cb%29)

// Install Nvidia Driver
sudo dnf install akmod-nvidia
sudo dnf install xorg-x11-drv-nvidia-cuda
other options got to [RPM Fusion/Howto/Nvidia](https://rpmfusion.org/Howto/NVIDIA?highlight=%28%5CbCategoryHowto%5Cb%29).
